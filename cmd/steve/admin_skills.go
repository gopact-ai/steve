...
func (a *fleetAdmin) Skills(ctx context.Context) (consoleapi.SkillsView, error) {
	if a.skills == nil || a.skills.Map == nil {
		return consoleapi.SkillsView{}, errors.New("技能没有配置")
	}
	view := consoleapi.SkillsView{Fingerprint: a.skills.Map.Fingerprint(), SearchPaths: a.skills.Map.SearchPaths(), BuiltinRoot: a.skills.Map.BuiltinRootPath(), Skills: []consoleapi.SkillView{}, Nodes: []consoleapi.SkillNode{}, Sources: []consoleapi.SkillSource{}}
...
func (a *fleetAdmin) SkillContent(_ context.Context, name string) (consoleapi.SkillDoc, error) {
	if a.skills == nil || a.skills.Map == nil {
...
func (a *fleetAdmin) MachineSkills(ctx context.Context) []consoleapi.MachineSkills {
...
func (a *fleetAdmin) RefreshMachineSkills(ctx context.Context) []consoleapi.MachineSkills {
	ownSkillsRescan()
	names := a.nodes.Names()
...
func (a *fleetAdmin) AddSkillSource(ctx context.Context, spec string) (consoleapi.SkillSource, error) {
	if a.skills == nil || a.skills.Map == nil {
...
func (a *fleetAdmin) UpdateSkillSources(ctx context.Context) ([]consoleapi.SkillSource, error) {
