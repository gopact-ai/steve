...
func TestVersionsReportsIdentityWithoutCredentialsOrInstalling(t *testing.T) {
	a := &fleetAdmin{cfg: &config.Config{Gateway: config.Gateway{HubID: "stable-hub", Peers: map[string]config.HubPeer{"other": {URL: "https://hub.example", Token: "private-test-value"}}}}}
