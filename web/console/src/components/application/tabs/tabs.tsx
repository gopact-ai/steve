...
const sizes = {
    sm: {
        ...
        "button-brand": "py-1 px-2.5",
        "button-gray": "py-1 px-2.5",
        "button-border": "py-1 px-2.5",
        "button-minimal": "py-1 px-2.5",
        underline: "px-0.5 pb-2 pt-0",
        line: "pl-2.5 pr-3 py-0.5",
    },
    md: {
        base: "text-sm font-medium gap-1.5 *:data-icon:size-4",
        "button-brand": "py-1.5 px-3",
        "button-gray": "py-1.5 px-3",
        "button-border": "py-1.5 px-3",
        "button-minimal": "py-1.5 px-3",
