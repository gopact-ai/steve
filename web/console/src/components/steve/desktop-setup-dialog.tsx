...
export function DesktopSetupDialog({ status, entry, onClose, onStatus }: { status: DesktopStatus; entry: SetupStep | null; onClose: () => void; onStatus: (status: DesktopStatus) => void }) {
    const { t } = useI18n();
