...
export interface PendingQuestion { id: string; request_id?: string; session_id?: string; conversation: string; exchange_id: string; project?: string; task_id?: string; attempt_id?: string; agent?: string; node?: string; kind: "permission" | "question" | "recovery"; title?: string; message: string; options: { id: string; label: string; description?: string; kind?: string }[]; allow_free_text?: boolean; required: boolean; locale?: string; created_at: string; deadline: string; updated_at: string; state: "pending" | "answered" | "declined" | "cancelled" | "expired" | "interrupted"; answer?: QuestionAnswer }
