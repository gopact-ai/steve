...
export const saveNodeSettings = (name: string, settings: NodeSettings) => request<{ settings: NodeSettings }>(`/console/nodes/${encodeURIComponent(name)}/settings`, { method: "PUT", body: settings });
