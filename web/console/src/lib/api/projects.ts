...
export const retryConflict = (artifact: string, landing: string) => request<{ ok: boolean }>(`/console/conflicts/${encodeURIComponent(artifact)}/retry`, { method: "POST", body: { landing } });
