...
func Continue(locale i18n.Locale, homePath, excerpts string) string {
	...
	b.WriteString("- SOUL.md is Steve's identity as their personal assistant. Codex/Claude/Grok/Kimi are hands, not another self.\n")
	b.WriteString("- Keep the Feishu open_id line if it exists. Do not include the template marker comment.\n")
