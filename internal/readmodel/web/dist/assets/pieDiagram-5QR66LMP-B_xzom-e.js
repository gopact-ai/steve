import{ht as e,pt as t}from"./noop-CdBy4H-p.js";import{m as n}from"./dist-B_J_HbC0.js";import{t as r}from"./arc-DURrNsBq.js";import{i,p as a}from"./chunk-ZIGJFQKS-Bfe3v5g-.js";import{n as o}from"./ordinal-CPleeUAT.js";import{n as s}from"./src-B4ble-Uq.js";import{n as c}from"./mermaid-parser.core-LFoRWaTf.js";import{n as l}from"./chunk-Y2CYZVJY-DsF7k-Jl.js";import{H as u,U as d,a as f,c as p,f as m,q as h,v as g,w as _,x as v,y}from"./chunk-O7XYJQB3-PKD_DggL.js";import{t as b}from"./chunk-JWPE2WC7-DVXcaiue.js";import{a as x}from"./mermaid.core-psrcxsjb.js";function S(e,t){return t<e?-1:t>e?1:t>=e?0:NaN}function C(e){return e}function w(){var r=C,i=S,a=null,o=e(0),s=e(n),c=e(0);function l(e){var l,u=(e=t(e)).length,d,f,p=0,m=Array(u),h=Array(u),g=+o.apply(this,arguments),_=Math.min(n,Math.max(-n,s.apply(this,arguments)-g)),v,y=Math.min(Math.abs(_)/u,c.apply(this,arguments)),b=y*(_<0?-1:1),x;for(l=0;l<u;++l)(x=h[m[l]=l]=+r(e[l],l,e))>0&&(p+=x);for(i==null?a!=null&&m.sort(function(t,n){return a(e[t],e[n])}):m.sort(function(e,t){return i(h[e],h[t])}),l=0,f=p?(_-u*b)/p:0;l<u;++l,g=v)d=m[l],x=h[d],v=g+(x>0?x*f:0)+b,h[d]={data:e[d],index:l,value:x,startAngle:g,endAngle:v,padAngle:y};return h}return l.value=function(t){return arguments.length?(r=typeof t==`function`?t:e(+t),l):r},l.sortValues=function(e){return arguments.length?(i=e,a=null,l):i},l.sort=function(e){return arguments.length?(a=e,i=null,l):a},l.startAngle=function(t){return arguments.length?(o=typeof t==`function`?t:e(+t),l):o},l.endAngle=function(t){return arguments.length?(s=typeof t==`function`?t:e(+t),l):s},l.padAngle=function(t){return arguments.length?(c=typeof t==`function`?t:e(+t),l):c},l}var T=m.pie,E={sections:new Map,showData:!1,config:T},D=E.sections,O=E.showData,k=structuredClone(T),A={getConfig:l(()=>structuredClone(k),`getConfig`),clear:l(()=>{D=new Map,O=E.showData,f()},`clear`),setDiagramTitle:h,getDiagramTitle:_,setAccTitle:d,getAccTitle:y,setAccDescription:u,getAccDescription:g,addSection:l(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);D.has(e)||(D.set(e,t),s.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:l(()=>D,`getSections`),setShowData:l(e=>{O=e},`setShowData`),getShowData:l(()=>O,`getShowData`)},j=l((e,t)=>{b(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),M={parse:l(async e=>{let t=await c(`pie`,e);s.debug(t),j(t,A)},`parse`)},N=l(e=>`
  .pieCircle{
