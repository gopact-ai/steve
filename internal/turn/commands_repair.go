// The /repair and /fleet probe commands: mending a machine that a task
// or a plan cannot run on as configured.
...
func (c commands) repairCmd(ctx context.Context, req Request, rest string) Result {
	...
	if c.supervisor == nil || c.fleet == nil {
