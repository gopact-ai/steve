...
// turnCopy is every word a turn card says, in text's language.
func turnCopy(text i18n.Catalog) card.Copy {
	return card.Copy{
		Title:          text.T(i18n.CardTitle),
		Running:        text.T(i18n.CardRunning),
		Completed:      text.T(i18n.CardCompleted),
		Failed:         text.T(i18n.CardFailed),
		Cancelled:      text.T(i18n.CardCancelled),
		EarlierTools:   text.T(i18n.CardEarlierTools),
		Partial:        text.T(i18n.CardPartial),
		Execution:      text.T(i18n.CardExecution),
		Plan:           text.T(i18n.CardPlan),
		EarlierSteps:   text.T(i18n.CardEarlierSteps),
		Input:          text.T(i18n.CardInput),
		Output:         text.T(i18n.CardOutput),
		Context:        text.T(i18n.CardContext),
		In:             text.T(i18n.CardIn),
		Out:            text.T(i18n.CardOut),
		Hit:            text.T(i18n.CardHit),
		Write:          text.T(i18n.CardWrite),
		Awaiting:       text.T(i18n.CardAwaiting),
		Waking:         text.T(i18n.CardWaking),
		Finishing:      text.T(i18n.CardFinishing),
		Saving:         text.T(i18n.CardSaving),
		Stop:           text.T(i18n.CardStop),
		Retry:          text.T(i18n.CardRetry),
		ApprovalTitle:  text.T(i18n.CardApprovalTitle),
		ApprovalTool:   text.T(i18n.CardApprovalTool),
		ApprovalReason: text.T(i18n.CardApprovalReason),
		ApprovalRule:   text.T(i18n.CardApprovalRule),
		QuestionTitle:  text.T(i18n.CardQuestionTitle),
		QuestionHint:   text.T(i18n.CardQuestionHint),
		Recover:        text.T(i18n.CardRecover),
		SentTo:         text.T(i18n.CardSentTo),
		AllowOnce:      text.T(i18n.CardAllowOnce),
		Deny:           text.T(i18n.CardDeny),
	}
}
