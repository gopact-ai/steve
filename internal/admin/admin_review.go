...
func (a *Service) attemptSnapshot(ctx context.Context, attemptID string) (attempt.Record, string, string, error) {
...
func (a *Service) AttemptTree(ctx context.Context, attemptID, dir string) (consoleapi.TreeView, error) {
...
func (a *Service) AttemptFile(ctx context.Context, attemptID, path string) (consoleapi.FileView, error) {
...
func (a *Service) changeSnapshots(ctx context.Context, attemptID string) (attempt.Record, string, string, error) {
...
func (a *Service) AttemptChanges(ctx context.Context, attemptID string) (consoleapi.ChangeIndex, error) {
	record, base, after, err := a.changeSnapshots(ctx, attemptID)
	if err != nil {
...
func (a *Service) AttemptDiff(ctx context.Context, attemptID, path string) (consoleapi.FileDiff, error) {
	record, base, after, err := a.changeSnapshots(ctx, attemptID)
	if err != nil {
